...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="cart">
            <a href="database/cart.php" class="btn btn-outline-secondary">GIỎ HÀNG <span class="text-danger"><?php if (isset($_SESSION['cart'])) {
                                                                                                                    $qtt = 0;
    ...
    <?php if (empty($search)) { ?>
        ...
        <div class="container pb-5" id="myselect">
            <div class="row">
                <?php
