    ...
    <div>
        ...
        <table class="table table-bordered table-dark text-center mt-3">
            <tr>
                ...
                <th class="d-none d-md-table-cell" scope="col">Ngày mua</th>
            ...
            ?>
                <tr>
                    <td class="d-none d-md-table-cell"><?= $row['id_order'] ?></td>
                    <td scope="row"><?= $row['Name'] ?></td>
                    <td><?= $row['address'] ?></td>
                    <td><?= $row['phone'] ?></td>
                    <td class="d-none d-md-table-cell"><?= date('d/m/Y H:i', $row['created_time']) ?></td>
